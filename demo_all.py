            ...
            if label == 'person':
                if c1[0]>int(256/b) and c1[1]>int(290/b) and c2[0]<int(1238/b) and c2[1]<int(704/b):  #c1[1]>int(95/b)
                    ...
                    if c1[0]>int(141/b) and c1[1]>int(367/b) and c2[0]<int(1238/b) and c2[1]<int(704/b):
                        #print(str(c1)+str(c2))
                        humans = e.inference(frame[c1[1]-15:c2[1]+15, c1[0]-30:c2[0]+30, :],
                                             resize_to_default=(w > 0 and h > 0), upsample_size=args.resize_out_ratio)
                        frame[c1[1]-15:c2[1]+15, c1[0]-30:c2[0]+30, :] = TfPoseEstimator.draw_humans(
                            frame[c1[1]-15:c2[1]+15, c1[0]-30:c2[0]+30, :], humans, imgcopy=False)
                        cv2.rectangle(frame, (c1[0]-30,c1[1]-15), (c2[0]+30,c2[1]+15),(0,255,0), 1)
